...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=localhost;database=vacaciones_db;user=5to_agbd;password=Trigg3rs!", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.43-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<SaldoVacacionesCopy1>(entity =>
        {
            ...
            entity.ToTable("saldo_vacaciones_copy1");
            ...
            entity.HasOne(d => d.IdEmpleadoNavigation).WithMany(p => p.SaldoVacacionesCopy1s)
                .HasForeignKey(d => d.IdEmpleado)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("saldo_vacaciones_ibfk_10");
        });
